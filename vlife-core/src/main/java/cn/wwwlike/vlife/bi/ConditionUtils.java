...
public class ConditionUtils {
   ...
   //条件组匹配判断
    ...
    //视图条件表达式替换
    public static String condtionJsonElTran(String conditionJson, String userId,String deptId,String deptCode){
        return conditionJson.replace("{{currUser}}", userId).replace("{{currDept}}",deptId);
    }
