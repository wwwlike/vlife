...
public enum MethodTypeEnum implements Method {
    //save commit
    save("保存","save", PostMapping.class, IdBean.class,"dto",IdBean.class,RequestBody.class,NAME_ALL,MethodContent.save),
    commit("提交","",PostMapping.class,IdBean.class,"dto",IdBean.class,RequestBody.class,NAME_KEY,MethodContent.save),
    //remove
    remove("逻辑删除","remove", DeleteMapping.class,String.class,"id",Long.class, PathVariable.class,NAME_PREFIX,MethodContent.remove),
    // query
