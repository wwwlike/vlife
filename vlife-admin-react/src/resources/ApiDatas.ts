...
import { deptOpenApi, dictOpenApi, fieldOpenApi, formOpenApi, groupOpenApi, menuOpenApi, resourcesOpenApi,resourcesButtonOpenApi, routeOpenApi, userOpenApi } from './apis/Admin';
