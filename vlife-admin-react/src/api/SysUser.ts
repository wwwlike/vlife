...
export class MyDbEntity  {

}

export class MySysUser implements MyDbEntity {
  public id: string;
...
export const validateName = (
  ...
  return apiClient.get(`/sysUser/validate/name?str=${formData.name}`);
};
...
/** 
  * state修订停用启用
  */
 export const flow=(sysUser: Partial<SysUser>): Promise<Result<SysUser>>=>{
  return apiClient.post(`/sysUser/flow`  ,sysUser  );
};
...
/** 
  ...
  * @return
  */
 export const state=(userStateDto:Partial< UserStateDto>): Promise<Result<string[]>>=>{
  return apiClient.post(`/sysUser/state`  ,userStateDto  );
};
